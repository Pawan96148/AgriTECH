...
export const DEFAULT_REGISTERED_ACCOUNTS: User[] = [
  ...
  },
  {
    ...
    lastLoginAt: '2026-03-30 08:30 AM',
    isEmailVerified: true,
...
export const INITIAL_FARMS: Farm[] = [
  {
    ...
    soilType: 'Black',
    irrigationType: 'Drip',
    notes: 'Primary deep fertile soil parcel with solar-powered drip filtration system in Ormanjhi, Ranchi.',
  ...
  },
  {
    id: 'farm_03',
    userId: 'usr_farmer_01',
    farmName: 'Ramgarh Hillside Farm',
...
export const INITIAL_ORDERS: Order[] = [
  {
    ...
    currentLocation: {
      ...
      speed: 0,
      heading: 0,
      lastUpdated: `${getRelativeDate(-1)} 02:45 PM`
    },
    farmerId: 'usr_farmer_jharkhand',
    farmerName: 'Ramesh Mahto',
    farmerPhone: '+91 94311 55678',
  ...
  },
  {
    ...
    locationHistory: [
      { latitude: 23.4833, longitude: 85.4833, timestamp: `${getRelativeDate(-1)} 05:00 PM` },
      { latitude: 23.3441, longitude: 85.3096, timestamp: `${getRelativeDate(0)} 06:15 AM` },
      { latitude: 23.0125, longitude: 85.8340, timestamp: `${getRelativeDate(0)} 08:30 AM` }
    ],
    farmerId: 'usr_farmer_jharkhand',
    farmerName: 'Ramesh Mahto',
    farmerPhone: '+91 94311 55678',
