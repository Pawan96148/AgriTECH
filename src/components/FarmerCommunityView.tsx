    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="shrink-0 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <button
              ...
              className="w-full sm:w-auto min-h-11 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-linear-to-r from-lime-400 to-lime-500 hover:from-lime-300 hover:to-lime-400 text-emerald-950 font-extrabold text-sm shadow-lg hover:shadow-xl transition transform active:scale-95 cursor-pointer"
            >
                  ...
                  <div className="pt-3 border-t border-lime-100 flex items-center justify-between text-xs">
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className={`min-h-9.5 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl font-bold transition active:scale-95 cursor-pointer ${
                          isLiked
                      ...
                      <button
                        ...
                        className="min-h-9.5 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl font-bold bg-lime-50 hover:bg-lime-100 text-emerald-950 border border-lime-200 transition active:scale-95 cursor-pointer"
                      >
                    ...
                    <div className="pt-3 border-t border-dashed border-stone-200 space-y-3 bg-stone-50/50 p-3.5 rounded-xl">
                      ...
                      <div className="flex items-center gap-2 pt-2">
                        <input
                          ...
                          className="min-h-9.5 flex-1 bg-white border border-stone-300 rounded-xl px-3 py-2 text-xs text-stone-900 focus:outline-none focus:ring-1 focus:ring-emerald-700"
                        />
                        <button
                          onClick={() => handleAddComment(post.id)}
                          disabled={submittingComment[post.id] || !(commentInputs[post.id] || '').trim()}
                          className="min-h-9.5 px-3.5 py-2 bg-emerald-800 hover:bg-emerald-900 text-white rounded-xl text-xs font-bold transition active:scale-95 cursor-pointer disabled:opacity-50 flex items-center gap-1 shrink-0"
                        >
      ...
      {isPostModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center p-0 sm:p-4 z-50">
          <div className="bg-white rounded-none sm:rounded-3xl max-w-xl w-full h-dvh sm:h-auto sm:max-h-[92vh] flex flex-col border border-lime-200 shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-150">
            {/* Modal Header */}
            <div className="bg-linear-to-r from-emerald-900 to-emerald-950 text-white p-4 sm:p-5 flex items-center justify-between shrink-0">
              <div>
              ...
              <button
                ...
                className="w-10 h-10 min-w-10 min-h-10 rounded-full hover:bg-emerald-800 text-emerald-200 hover:text-white transition cursor-pointer flex items-center justify-center"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleCreatePost} className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-4 flex flex-col justify-between">
              ...
              <div className="pt-4 border-t border-stone-100 flex flex-col-reverse sm:flex-row sm:items-center justify-end gap-2.5 pb-safe">
                <button
                  type="button"
                  onClick={() => setIsPostModalOpen(false)}
                  className="w-full sm:w-auto min-h-10.5 px-4 py-2 bg-stone-100 hover:bg-stone-200 text-stone-700 rounded-xl text-xs font-bold transition cursor-pointer flex items-center justify-center"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="w-full sm:w-auto min-h-10.5 px-5 py-2 bg-emerald-800 hover:bg-emerald-900 text-white rounded-xl text-xs font-bold transition shadow-xs cursor-pointer disabled:opacity-50 flex items-center justify-center"
                >
