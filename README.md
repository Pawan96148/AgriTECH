...
- **AI-Powered Assistance:** Integrated Gemini API features smarter agriculture-related queries aur assistance ke liye.
- **Modern UI/UX:** Fast aur responsive user interface jo Vite aur TypeScript ke saath built hai.
